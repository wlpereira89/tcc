...
CREATE TABLE INFORMACAO_SINOMIMOS (
  ID1 INT,
  ID2 INT,
  CONSTRAINT PK_INFORMACAO_SINOMIMOS PRIMARY KEY(ID1, ID2),
  CONSTRAINT FK_INFORMACAO_SINOMIMOS1 FOREIGN KEY (ID1) REFERENCES INFORMACAO (ID),
  CONSTRAINT FK_INFORMACAO_SINOMIMOS2 FOREIGN KEY (ID2) REFERENCES INFORMACAO (ID)
)

CREATE TABLE INFORMACAO_SINOMIMOS_Levenshtein (
  ID1 INT,
  ID2 INT,
  CONSTRAINT PK_INFORMACAO_SINOMIMOS_Levenshtein PRIMARY KEY(ID1, ID2),
  CONSTRAINT FK_INFORMACAO_SINOMIMOS_Levenshtein1 FOREIGN KEY (ID1) REFERENCES INFORMACAO (ID),
  CONSTRAINT FK_INFORMACAO_SINOMIMOS_Levenshtein2 FOREIGN KEY (ID2) REFERENCES INFORMACAO (ID)
)

CREATE TABLE INFORMACAO_SINOMIMOS_SOUNDEX (
  ID1 INT,
  ID2 INT,
  CONSTRAINT PK_INFORMACAO_SINOMIMOS_SOUNDEX PRIMARY KEY(ID1, ID2),
  CONSTRAINT FK_INFORMACAO_SINOMIMOS_SOUNDEX1 FOREIGN KEY (ID1) REFERENCES INFORMACAO (ID),
  CONSTRAINT FK_INFORMACAO_SINOMIMOS_SOUNDEX2 FOREIGN KEY (ID2) REFERENCES INFORMACAO (ID)
)

CREATE TABLE INFORMACAO_SINOMIMOS_Levenshtein_SOUNDEX (
  ID1 INT,
  ID2 INT,
  CONSTRAINT PK_INFORMACAO_SINOMIMOS_Levenshtein_SOUNDEX PRIMARY KEY(ID1, ID2),
  CONSTRAINT FK_INFORMACAO_SINOMIMOS_Levenshtein_SOUNDEX1 FOREIGN KEY (ID1) REFERENCES INFORMACAO (ID),
  CONSTRAINT FK_INFORMACAO_SINOMIMOS_Levenshtein_SOUNDEX2 FOREIGN KEY (ID2) REFERENCES INFORMACAO (ID)
)
